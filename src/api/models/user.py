...
class User(db.Model):
    ...
    written_reviews = db.relationship("Review", back_populates="user", foreign_keys="Review.user_id")
    received_reviews = db.relationship("Review", back_populates="company_user", foreign_keys="Review.company_user_id")
